...
import Application.Model.CustomTrace.ConvertTrace;
...
public class Controller {
	...
	public void convertTrace() {
		File traceFile = new File(this.tracePath);
		String path = this.prop.getProperty("PathTraceConverted");
		ConvertTrace ct = new ConvertTrace(traceFile, path ,this.LOGGER);
